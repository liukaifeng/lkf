...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			<span class="logo-mini"><b>lkf</b></span>
...
<#macro commonFooter >
	<footer class="main-footer">
        Powered by <b>lkf-JOB</b> 1.9.0（快照版本）
		<div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2015-${.now?string('yyyy')} &nbsp;
                <a href="http://www.lkf.com/" target="_blank" >lkf</a>
				&nbsp;
                <a href="https://github.com/lkf/lkf-job" target="_blank" >github</a>
