package com.lkf.job.admin.service.impl;
...
public class JobServiceImpl implements JobService {
	...
	public Map<String, Object> pageList(int start, int length, int jobGroup, String executorHandler, String filterTime) {
		...
		// page list
		List<JobInfo> list = xxlJobInfoDao.pageList(start, length, jobGroup, executorHandler);
	...
	public ReturnT<String> add(JobInfo jobInfo) {
		...
		if (StringUtils.isNotBlank(jobInfo.getChildJobKey())) {
			...
			for (String childJobKeyItem: childJobKeys) {
				...
				JobInfo childJobInfo = xxlJobInfoDao.loadById(Integer.valueOf(childJobKeyArr[1]));
