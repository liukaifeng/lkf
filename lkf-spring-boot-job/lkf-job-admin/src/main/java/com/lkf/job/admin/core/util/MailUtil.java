package com.lkf.job.admin.core.util;
...
public class MailUtil {
	...
	static{
		host = PropertiesUtil.getString("lkf.job.mail.host");
		port = PropertiesUtil.getString("lkf.job.mail.port");
		username = PropertiesUtil.getString("lkf.job.mail.username");
		password = PropertiesUtil.getString("lkf.job.mail.password");
		sendFrom = PropertiesUtil.getString("lkf.job.mail.sendFrom");
		sendNick = PropertiesUtil.getString("lkf.job.mail.sendNick");
	}
