...
public class GenericRef {
    ...
    public GenericRef(RefType type, String ref) {
        ...
        if (format == RefFormat.INTERNAL && !ref.startsWith("#/")) {
            ...
            while currently relies on the ability to create com.lkf.swagger.docs.domain.RefModel/RefProperty objects via a constructor call like
            1) new com.lkf.swagger.docs.domain.RefModel("Animal")..and expects get$ref to return #/definitions/Animal
            2) new com.lkf.swagger.docs.domain.RefModel("http://blah.com/something/file.json")..and expects get$ref to turn the URL
             */
